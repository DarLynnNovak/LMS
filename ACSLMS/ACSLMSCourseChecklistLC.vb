...
Public Class ACSLMSCourseChecklistLC
    ...
    Private WithEvents EventIdCB As AptifyCheckBox
    ...
    Protected Overridable Sub FindControls()
        Try
            ...
            CourseIdCreated = FormTemplateContext.GE.GetValue("CourseIdCreated")
    ...
    Public Sub CheckCourseOwnerLB()
        ...
        If Me.FormTemplateContext.GE.RecordID > 0 Then
            ...
            If CourseIdCreated > 0 AndAlso ProductIdCreated > 0 Then
